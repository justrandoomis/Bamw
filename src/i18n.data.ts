...
export const translations: Record<string, { en: string; ku: string; tr?: string }> = {
  ...
  "ابحث عن لعبة أو بطاقة أو جهاز...": {
    en: "Search for a game, a card or a console...",
    ku: "گەڕان بۆ یاری، کارت یان ئامێر...",
  },
  ...
  "اكتب اسم اللعبة التي تبحث عنها": {
    en: "Type the name of the game you are looking for",
    ku: "ناوی ئەو یارییە بنووسە کە بەدوایدا دەگەڕێیت",
  },
  ...
  "لم نجد ما يطابق بحثك": {
    ...
    ku: "هیچ شتێک لەگەڵ گەڕانەکەت نەگونجا",
  },
  "ابحث في المتجر": { en: "Search the store", ku: "لە فرۆشگا بگەڕێ" },
  "جرّب اسمًا أقصر أو الاسم بالإنجليزية": {
    en: "Try a shorter name, or the English one",
    ku: "ناوێکی کورتتر یان ناوی ئینگلیزی تاقی بکەرەوە",
  },
  "اكتب اسم اللعبة، أو جرّب أحد الاقتراحات": {
    en: "Type a game's name, or try one of the suggestions",
    ku: "ناوی یارییەک بنووسە، یان یەکێک لە پێشنیارەکان تاقی بکەرەوە",
  },
  /*
    The four help pages.
  ...
  */
  ...
  "اتبع الخطوات حسب الخيار الموجود في طلبك. لا تحذف مستخدم حساب اللعبة، ولا تغيّر بيانات الحساب، ولا تضغط Forgot your password. عند طلب رمز تحقق، أرسل صورة كاملة للشاشة داخل محادثة الطلب وانتظر تعليمات الأدمن.":
    {
      en: "Follow the steps for the option on your order. Do not delete the game account user, do not change the account details, and do not press Forgot your password. If a verification code is requested, send a full screenshot inside your order chat and wait for staff instructions.",
      ku: "هەنگاوەکان بەپێی ئەو هەڵبژاردنەی لە داواکاریەکەتدایە جێبەجێ بکە. بەکارهێنەری هەژماری یاری مەسڕەوە، زانیاری هەژمار مەگۆڕە، و Forgot your password دامەگرە. ئەگەر کۆدی پشتڕاستکردنەوە داوا کرا، وێنەی تەواوی شاشەکە بنێرە ناو گفتوگۆی داواکارییەکەت و چاوەڕێی ڕێنمایی بەڕێوەبەر بکە.",
    },
  "تسجيل الدخول مشترك بين Offline وOnline؛ الاختلاف يظهر عند تشغيل اللعبة فقط.": {
    en: "Signing in is the same for Offline and Online; the difference only appears when you play.",
    ku: "چوونەژوورەوە بۆ Offline و Online وەک یەکە؛ جیاوازییەکە تەنها لە کاتی یاریکردندا دەردەکەوێت.",
  },
  ...
  "لا توجد أدلة منشورة حالياً.": {
    en: "No guides are published yet.",
    ku: "هێشتا هیچ ڕێنماییەک بڵاو نەکراوەتەوە.",
  },
  ...
  "لا توجد بنود منشورة حالياً.": {
    en: "No clauses are published yet.",
    ku: "هێشتا هیچ بڕگەیەک بڵاو نەکراوەتەوە.",
  },
  "أجوبة قصيرة، ورابط للشرح الكامل في الدليل أو السياسة.": {
    en: "Short answers, with a link to the full explanation in the guide or the policy.",
    ku: "وەڵامی کورت، لەگەڵ بەستەرێک بۆ ڕوونکردنەوەی تەواو لە ڕێنمایی یان سیاسەتدا.",
  },
  ...
  "لا يوجد سؤال يطابق بحثك.": {
    ...
    ku: "هیچ پرسیارێک لەگەڵ گەڕانەکەت ناگونجێت.",
  },
