...
say(
  `ملاحظة على النطاق: Cloudflare يردّ **403** على هذا المُشغّل — على \`/api/data\` وعلى \`/product/<id>\` كذلك — حتى من داخل متصفّح Chrome حقيقي يجتاز التحدي على الصفحة الرئيسية. لذلك القسم الأول (قاعدة البيانات) موثوق، والقسم الثاني (ما تعرضه الصفحة) لا يمكن قياسه من هنا. شغّل هذا السكربت من شبكة غير محجوبة، أو اسمح لنطاق عناوين GitHub Actions، وسيكمل وحده.`,
);
